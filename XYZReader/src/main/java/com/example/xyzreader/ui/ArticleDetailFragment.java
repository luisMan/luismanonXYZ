...
public class ArticleDetailFragment extends Fragment implements
    ...
    //lets add sime slide transition for the text :-)
    ...
    private void bindViews() {
        ...
        //lets add some fun to the article title
        titleView.setTypeface(Typeface.createFromAsset(getResources().getAssets(),"Roboto-Bold.ttf"));
        //lets add italic style to the by line of our beautiful poster
        bylineView.setTypeface(Typeface.createFromAsset(getResources().getAssets(),"Roboto-Italic.ttf"));
        //lets add regular look to the  body
        ...
        if (mCursor != null) {
            ...
            //implemented the glide api from google to load big images .. this app was not updated thus I needed to update must of the libraries in
            //order for this app to work.
            Glide.with(this)
