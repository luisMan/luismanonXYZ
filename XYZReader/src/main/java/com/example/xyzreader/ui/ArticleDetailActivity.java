...
public class ArticleDetailActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //I love coding review that way am pointed to the right task
        // now taking notes on the setOnPageChange listener method is deprecated thus now am updating the code
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            mUpButtonContainer.setOnApplyWindowInsetsListener(new View.OnApplyWindowInsetsListener() {
                ...
                public WindowInsets onApplyWindowInsets(View view, WindowInsets windowInsets) {
                    //lets now do some version check since we want to get all the nice features avaliable for sdk versions
